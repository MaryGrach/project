...
type UserProfile struct {
	...
	OldPassword string `json:"old_password,omitempty"` // Поле для проверки старого пароля
	NewPassword string `json:"new_password,omitempty"` // Поле для нового пароля
}

type Password struct {
	ID         int    `json:"id"`
	Passwrd    string `json:"password"`
	NewPasswrd string `json:"new_password"`
}
...
func (h Password) Validate() error {
	return nil
}
